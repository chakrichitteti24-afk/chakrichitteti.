          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 w-full mt-8 lg:mt-0">
            {features.map((feature, idx) => (
              <motion.div
                ...
                className="bg-card/40 backdrop-blur-sm border border-border p-6 md:p-8 rounded-2xl hover:border-accent/40 transition-colors duration-300 group"
              >
                <div className="mb-4 md:mb-6 inline-flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-xl bg-background border border-border/50 text-accent group-hover:bg-accent/10 transition-colors duration-300 shadow-sm">
                  {feature.icon}
                </div>
